//
//  VSCSlidingPanelViewController.swift
//  Tawsila
//
//  Created by vikram singh charan on 6/10/17.
//  Copyright © 2017 scientificweb. All rights reserved.
//

import UIKit
enum VSCSlidingPanelState{
    case LeftVisible
    case CenterVisible
    case RightVisible
}
class VSCSlidingPanelViewController: UIViewController , UIGestureRecognizerDelegate {
    ...
    private var slidingPanelState: VSCSlidingPanelState = .CenterVisible {
    ...
    func toggleLeftSlidingPanel() {
        ...
        if self.slidingPanelState == VSCSlidingPanelState.LeftVisible {
    ...
    func toggleRightSlidingPanel() {
        ...
        if self.slidingPanelState == VSCSlidingPanelState.RightVisible {
    ...
    func leftPanelHamburgurButton() -> UIBarButtonItem {
        ...
        return UIBarButtonItem(image: VSCSlidingPanelViewController.defaultHamburgerImage(), style: UIBarButtonItemStyle.done, target: self, action: #selector(toggleLeftSlidingPanel))
    }
    ...
    func rightPanelHamburgurButton() -> UIBarButtonItem {
        ...
        return UIBarButtonItem(image: VSCSlidingPanelViewController.defaultHamburgerImage(), style: UIBarButtonItemStyle.done, target: self, action: #selector(toggleRightSlidingPanel))
    }
